...
async function decompress(value: Uint8Array): Promise<string> {
  // 'br' is the CompressionFormat for brotli in the browser Compression Streams API
...
export function ViewerBrotli({ value }: { value: Uint8Array }) {
    ...
    return (
      <div className="h-full w-full p-3">
        <div className="px-3 py-2 text-sm text-destructive bg-destructive/10 border border-destructive/20 rounded">
          Brotli decompression failed: {error}
        </div>
      </div>
    )
  }
